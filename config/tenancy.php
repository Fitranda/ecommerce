...
return [
    ...
    'bootstrappers' => [
        ...
        // Stancl\Tenancy\Bootstrappers\CacheTenancyBootstrapper::class, // Disabled: file driver doesn't support tagging
     ...
     */
    'seeder_parameters' => [
        '--class' => 'Database\Seeders\TenantDatabaseSeeder', // tenant seeder class
